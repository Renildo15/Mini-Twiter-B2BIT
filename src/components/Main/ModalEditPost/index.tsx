...
export default function ModalEditPost({ 
  ...
  return (
    <div className="absolute inset-0 bg-white/90 rounded-lg flex items-center justify-center z-20 p-4">
      <div className="bg-white p-6 rounded-lg shadow-lg border border-[#E2E8F0] w-full max-w-lg">
