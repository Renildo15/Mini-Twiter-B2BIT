...
export default function ModalDeletePost({
  ...
  isPending,
  setShowConfirm,
}: IModalDeletePostProps) {
  return (
    <div className="absolute inset-0 bg-white/90 dark:bg-[#0F172B]/90 rounded-lg flex items-center justify-center z-10">
      <div className="bg-white dark:bg-[#0F172B] p-4 rounded-lg shadow-lg border border-[#E2E8F0] dark:border-[#62748E]">
        <p className="text-[#314158] dark:text-white mb-3">
